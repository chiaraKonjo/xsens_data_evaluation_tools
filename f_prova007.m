...
tree =load_mvnx('f_maria-007#MVM_Maria');
...
%right shoulder , frame 111 alla massima flessione ,
%da x sens vedo che x=ab-ad y=i-e  z=f-e 
tree.jointData(8).jointAngle(111,3) %frame 111= massima flessione 

rt=tree.jointData(7).jointAngle(111,:) ; %right tronco
rs=tree.jointData(8).jointAngle(111,:) ;   %right shoulder
re= tree.jointData(9).jointAngle(111,:) ;    %right elbow
rw= tree.jointData(10).jointAngle(111,:);        %right wrist
r= [rt;rs;re;rw]
...
%frame 311,posizione massima estensione ,braccio sx 
lt=tree.jointData(11).jointAngle(311,:) ; %left tronco
ls=tree.jointData(12).jointAngle(311,:) ;   %left shoulder
le= tree.jointData(13).jointAngle(311,:) ;    %left elbow
lw= tree.jointData(14).jointAngle(311,:);        %left wrist
l= [lt;ls;le;lw]
